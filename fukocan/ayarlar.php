...
$yaz = @mysql_query("UPDATE ayarlar SET sitead = '$ad', logo = '$logo', copyright = '$copyright', admin_mail = '$admin_mail', slogan = '$slogan', sayfadefacesayisi = '$sayfadefacesayisi', sayfahabersayisi = '$sayfahabersayisi' WHERE id = 1 ");
...
echo '<tr><td>Site Sloganı:</td><td><input type="text" size="15" name="slogan" value="'.$ayarlar["slogan"].'"></td></tr>';
